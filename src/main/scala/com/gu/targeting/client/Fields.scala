...
case class ParticipationFields(callout: String, formId: Int, tagName: String, description: Option[String], prompt: Option[String], formFields: JsValue, formUrl: Option[String], contacts: Seq[Contact]) extends Fields
